# Generated by Django 3.2.9 on 2021-11-08 07:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='正文必须为MarkDown的格式', verbose_name='正文')),
                ...
                ('owenr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
